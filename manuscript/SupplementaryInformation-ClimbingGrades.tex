...
\input{../results/aus/ascents-from-2016-08-01-to-2021-08-01-minAscents400-minFails1-session-processing-table.tex}

A summary of the data processing for the New Zealand data analysis is shown in Table \ref{table-data-processing-nz}

\input{../results/nz/ascents-from-2016-08-01-to-2021-08-01-minAscents400-minFails1-session-processing-table.tex}
