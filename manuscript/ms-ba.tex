...
\runtitle{Bayesian inference of climbing grades}

\begin{aug}
\author[A,B]{\fnms{Alexei}~\snm{Drummond}\ead[label=e1]{a.drummond@auckland.ac.nz}\orcid{0000-0003-2826-4371}}
\and
\author[B]{\fnms{Alex}~\snm{Popinga}\ead[label=e2]{alexpopinga@gmail.com}\orcid{0000-0002-0152-5728}}

\address[A]{School of Computer Science,
University of Auckland, Auckland, New Zealand\printead[presep={,\ }]{e1}}

\address[B]{School of Biological Sciences,
University of Auckland, Auckland, New Zealand\printead[presep={,\ }]{e2}}

\runauthor{A. Drummond and A. Popinga}
\end{aug}
...
\begin{keyword}
\kwd{Bradley-Terry model}
\kwd{Markov chain Monte Carlo}
\kwd{climbing grades}
\kwd{Weber-Fechner law}
\kwd{Stan}
\end{keyword}
...
We implemented full Bayesian MCMC inference of the dynamic Bradley-Terry model in Stan \citep{carpenter2017stan}. This code is available to the public domain at \url{https://github.com/alexeid/climbing-grades}.
...
\sdescription{Additional figures showing individual climber slope estimates, Stan model code, and data processing details.}
\end{supplement}
