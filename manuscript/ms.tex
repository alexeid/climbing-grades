...
\author[1,2]{Alexei Drummond}
\author[2]{Alex Popinga}
\affil[1]{School of Computer Science, University of Auckland, Auckland, New Zealand}
\affil[2]{School of Biological Sciences, University of Auckland, Auckland, New Zealand}
...
%Finally, we note a natural corollary of this model that describes how the grade of a ``cruxy'' route can be decomposed into the grades of its constituent sections, or moves, and illustrate how this approach can be used, along with the slope parameter $m$, to quantify the contribution of fatigue to overall difficulty.}
...
%(in climbing lingo, their redpoint grade is higher than their flash grade). 
...
%Finally, we analyse a small data set of curated link-up boulder problems to illustrate the limitations of grading climbs in parts without considering fatigue.
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{figures/aus/ascents-from-2016-08-01-to-2021-08-01-minAscents30-minFails1-Sport-AU-session-posterior.png}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{figures/nz/ascents-from-2016-08-01-to-2021-08-01-minAscents30-minFails1-Sport-AU-session-posterior.png}
...
% Alex note: The paragraph below is very confusing (starts with "this is quite surprising" and ends with "this makes sense".  Also, in my personal experience, when climbers argue about grades they will OFTEN say a grade more than one higher or lower than what the route has been given; they just usually list two consecutive grades to lessen confusion (but sometimes will even officially list a range like 23-25!)  Personally, I would edit or even remove the whole paragraph.
